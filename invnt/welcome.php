  ...
  <body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
    <div class="jumbotron text-center">
      ...
      <?php  if (isset($_SESSION['email'])) : ?>
        Welcome <strong><?php echo $_SESSION['name']; echo " "; echo $_SESSION['surname']; echo $_SESSION['role']; ?></strong>
      <?php endif ?>
    </div>
    ...
    <div id="about" class="container">
      <nav class="navbar navbar-expand-lg navbar-light bg-light" style="font-size: 12px;">
        ...
        <li class="nav-item">
          ...
          <a class="nav-link active" href="welcome.php">HOME PAGE</a>
        </li>
      </ul>
        ...
        <p>Access: <?php echo $_SESSION['role'];?></p>
