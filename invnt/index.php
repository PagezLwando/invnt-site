  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light container" style="font-size: 12px;">
    <div class="collapse navbar-collapse">
      ...
      <ul class="navbar-nav nav-tabs mr-auto mt-2 mt-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="register.php" onclick="myFunction()">REGISTER</a>
        </li>
      </ul>
    </div>
  </nav>
  ...
  <div class="row">
    ...
    <div class="col-sm-4">
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          <a class="btn btn-outline-danger btn-lg btn-block" role="button" href="register.php" onclick="myFunction()">Signup</a>
        </div>
      </div>
    </div>
    <div class="col-sm-4">
